...
adminApp.factory("UserDashboardService",['requestHandler',function(requestHandler){
    ...
    userDashboardServiceObj.searchFoodByCoach=function(searchStr){
        return requestHandler.postRequest("coach/searchFoodListByCoach/",{"foodname":searchStr}).then(function (response) {
